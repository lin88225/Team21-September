...
void createScreens(int i)
{
  ...
  } else if (i ==3)
  {
    ...
    {
      screenArray[i].addBarChart(barChartInts1, barChartLabels1, SCREENX/5, 100, title1, "Number of flights on time, cancelled, and diverted", "");
    }
    if (barChartLabels2.length !=0) {
      screenArray[i].addBarChart(barChartInts2, barChartLabels2, SCREENX/5, 300, title2, "Number of flights on time, cancelled, and diverted", "");
    }
    if (barChartLabels3.length !=0) {
      screenArray[i].addBarChart(barChartInts3, barChartLabels3, SCREENX/5, 500, title3, "Number of flights on time, cancelled, and diverted", "");
    }
  } else if (i ==4)
  {
